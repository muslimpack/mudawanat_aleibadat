...
class LocalStorageRepo {
  ...
  static StatsRange getStatisticsTimeRange() {
    final value = _box.get(_statisticsTimeRangeKey) as String?;
    if (value == null) return StatsRange.all;
    return StatsRange.values.byName(value);
  }

  static Future changeStatisticsTimeRange(StatsRange timeRange) async {
